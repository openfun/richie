...
def set_labels_by_language(label):
    ...
    for code, _ in languages:
        labels.update({str(code): translate_message(code, label)})
    ...
    "children": [
        {
            ...
            "children": [
                ...
                {"page_title": set_labels_by_language("Earth science and science of the Universe")},
        ...
        },
        {
            ...
            "children": [
                ...
                {"page_title": set_labels_by_language("Social Issues and Social Policy")},
        ...
        {"page_title": set_labels_by_language("Entrepreneurship")},
        {
            ...
            "children": [
                ...
                {"page_title": set_labels_by_language("Telecommunication and Networks")},
...
HOMEPAGE_CONTENT = {
    str(code): {
        ...
        "banner_content": (
            f"""<h1 class="hero-intro__title">{translate_message(str(code), "Welcome")} <strong>{translate_message(str(code), "to Richie")}</strong></h1>"""
            f"""<p>{translate_message(str(code), "It works! This is the default homepage for the Richie CMS.")}</p>"""
        ),
...
SINGLECOLUMN_CONTENT = {
    str(code): {
        ...
        "banner_content": translate_message(str(code), "It works! This is a single column page."),
        "banner_template": "richie/large_banner/hero-intro.html",
        "button_template_name": "button-caesura",
...
FOOTER_CONTENT = {
    str(code): [
        {"name": translate_message(str(code), "About"), "link": {"internal_link": "annex__about"}},
        {"name": translate_message(str(code), "Sitemap"), "link": {"internal_link": "annex__sitemap"}},
        {"name": translate_message(str(code), "Style guide"), "link": {"external_link": "/styleguide/"}},
        {
