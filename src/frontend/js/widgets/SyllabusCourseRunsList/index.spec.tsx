...
import { CourseProductRelationFactory, PacedCourseFactory } from 'utils/test/factories/joanie';
...
describe('<SyllabusCourseRunsList/>', () => {
  ...
  it('has one opened product', async () => {
    ...
    const resourceLink = `https://joanie.endpoint/api/v1.0/courses/${course.courseLight.code}/products/${relation.product.id}/`;
