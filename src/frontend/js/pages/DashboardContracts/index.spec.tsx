...
describe('<DashboardContract/>', () => {
  ...
  it('renders an empty list of contract', async () => {
    ...
    await expectSpinner('Loading contracts...');
    ...
    await expectNoSpinner('Loading contract...');

    await expectBannerInfo('You have no contract yet.');
  });

  it('renders 3 pages of contract', async () => {
    ...
    fetchMock.get(
      'https://joanie.endpoint/api/v1.0/contracts/?page=2&page_size=10',
    ...
    expect(screen.queryByTestId('.dashboard__list--loading')).not.toBeInTheDocument();
