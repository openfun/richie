...
const messages = defineMessages({
  ...
  favoritLanguageInputLabel: {
    id: 'components.DashboardOpenEdxProfile.favoritLanguageInputLabel',
  ...
  fullNameInputDescription: {
    ...
    defaultMessage:
      'The name that appears on your certificates. Other learners never see your full name',
  },
...
const DashboardOpenEdxProfile = () => {
  ...
  const { data: openEdxProfileData } = useOpenEdxProfile({ username: user!.username });
        ...
        <DashboardBox header={<FormattedMessage {...messages.additionalInformationHeader} />}>
          ...
          <Form.Row>
            <Input
              ...
              label={intl.formatMessage(messages.favoritLanguageInputLabel)}
              disabled={true}
