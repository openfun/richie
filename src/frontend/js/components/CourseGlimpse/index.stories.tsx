...
import { CourseCertificateOffer, CourseOffer, isRichieCourse } from 'types/Course';
...
console.log({ courseLight });
if (isOffering(courseLight)) {
  console.log('isOffering');
} else if (isRichieCourse(courseLight)) {
  console.log('isRichieCourse');
} else {
  console.log('isJoanieCourse');
}
...
console.log({ courseGlimpseCourse });
