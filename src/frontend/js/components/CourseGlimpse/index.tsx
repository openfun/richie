...
export interface CourseGlimpseCourse {
  ...
  categories?: string[];
  offers?: {
    certificate_offer: Nullable<string>;
...
const CourseGlimpseBase = ({ context, course }: CourseGlimpseProps & CommonDataProps) => {
  ...
  return (
    <div
      className={c('course-glimpse', {
        'course-glimpse--offer-enrollment': hasEnrollmentOffer,
        // Enrollment offer has priority over certificate offer
        'course-glimpse--offer-certificate': !hasEnrollmentOffer && hasCertificateOffer,
      })}
