...
import sentry_sdk
from richie.base.utils import merge_dict
...
class Base(StyleguideMixin, DRFMixin, RichieCoursesConfigurationMixin, Configuration):
    ...
    * DB_PORT
    ...
    STORAGES = {
        ...
        "staticfiles": {
            "BACKEND": "richie.base.storage.CDNManifestStaticFilesStorage",
        },
    }
    ...
    CACHES = values.DictValue(
        {
            "default": {
                "BACKEND": values.Value(
                    "richie.base.cache.RedisCacheWithFallback",
...
class Production(Base):
    ...
    STORAGES = {
        "default": {
            "BACKEND": "richie.base.storage.MediaStorage",
        },
        "staticfiles": {
            "BACKEND": "richie.base.storage.CDNManifestStaticFilesStorage",
        },
