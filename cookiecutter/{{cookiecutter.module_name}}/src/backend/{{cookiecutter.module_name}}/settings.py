...
class Base(DRFMixin, RichieCoursesConfigurationMixin, Configuration):
    ...
    * DB_PORT
    ...
    INSTALLED_APPS = (
        # {{cookiecutter.module_name}} stuff
        "{{cookiecutter.module_name}}.base",
        # Richie stuff
        "richie.apps.search",
        "richie.apps.courses",
        "richie.apps.core",
    ...
    GIMPORTER_BASE_URL = values.Value(None)
...
class Production(Base):
    ...
    DEFAULT_FILE_STORAGE = "{{cookiecutter.module_name}}.storage.MediaStorage"

    # For static files in production, we want to use a backend that includes a hash in
    # the filename, that is calculated from the file content, so that browsers always
    # get the updated version of each file.
    STATICFILES_STORAGE = values.Value(
        "{{cookiecutter.module_name}}.storage.ConfigurableManifestS3Boto3Storage"
    )
    ...
    AWS_STATIC_BUCKET_NAME = values.Value(
        "production-{{cookiecutter.module_name}}-static"
    )
    AWS_MEDIA_BUCKET_NAME = values.Value(
        "production-{{cookiecutter.module_name}}-media"
    )
...
class Feature(Production):
    ...
    AWS_STATIC_BUCKET_NAME = values.Value("feature-{{cookiecutter.module_name}}-static")
    AWS_MEDIA_BUCKET_NAME = values.Value("feature-{{cookiecutter.module_name}}-media")
...
class Staging(Production):
    ...
    AWS_STATIC_BUCKET_NAME = values.Value("staging-{{cookiecutter.module_name}}-static")
    AWS_MEDIA_BUCKET_NAME = values.Value("staging-{{cookiecutter.module_name}}-media")
...
class PreProduction(Production):
    ...
    AWS_STATIC_BUCKET_NAME = values.Value("preprod-{{cookiecutter.module_name}}-static")
    AWS_MEDIA_BUCKET_NAME = values.Value("preprod-{{cookiecutter.module_name}}-media")
