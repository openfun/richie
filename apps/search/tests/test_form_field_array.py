...
class ArrayFieldTestCase(TestCase):
    ...
    def test_array_of_valid_int(self):
        ...
        array_of_int = ArrayField(required=False, base_type=forms.IntegerField(min_value=1))
    ...
    def test_array_of_invalid_string(self):
        ...
        """
        # Create an ArrayField instance with some params
        array_of_string = ArrayField(required=False, base_type=forms.CharField(max_length=4))
    ...
    def test_missing_required_array(self):
        ...
        """
        # Create an ArrayField instance with some params
        array_of_string = ArrayField(required=True, base_type=forms.CharField(max_length=4))
    ...
    def test_single_value(self):
        ...
        """
        # Create an ArrayField instance with some params
        array_of_string = ArrayField(required=False, base_type=forms.IntegerField(min_value=1))
