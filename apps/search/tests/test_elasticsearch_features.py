...
class ESFeaturesTestCase(TestCase):
    ...
    def test_search_match_all(self):
        ...
        bulk(
            actions=[
                {'_id': 1, '_index': 'test_index', '_op_type': 'create', '_type': 'test_doc'},
                {'_id': 2, '_index': 'test_index', '_op_type': 'create', '_type': 'test_doc'},
                {'_id': 3, '_index': 'test_index', '_op_type': 'create', '_type': 'test_doc'},
            ],
