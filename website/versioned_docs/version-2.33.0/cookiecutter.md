...
```bash
cookiecutter gh:openfun/richie --directory cookiecutter  --checkout v2.33.0
```
...
fundocker/cookiecutter gh:openfun/richie --directory cookiecutter --checkout v2.33.0
```
