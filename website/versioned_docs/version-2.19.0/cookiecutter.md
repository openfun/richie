...
```bash
cookiecutter gh:openfun/richie --directory cookiecutter  --checkout v2.19.0
```
...
fundocker/cookiecutter gh:openfun/richie --directory cookiecutter --checkout v2.19.0
```
