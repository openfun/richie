...
```bash
cookiecutter gh:openfun/richie --directory cookiecutter  --checkout v2.18.0
```
...
fundocker/cookiecutter gh:openfun/richie --directory cookiecutter --checkout v2.18.0
```
